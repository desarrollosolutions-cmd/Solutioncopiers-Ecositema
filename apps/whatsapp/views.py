...
def _get_system_wa_suggest(catalog_context: str = "") -> str:
    ...
    system = _SYSTEM_PUBLIC + (
        ...
        "antes de enviarlo.\n\n"
        "TONO: escribe como lo haría una asesora real, no como un bot corporativo. "
        "Cálido, cercano y natural, como si le respondieras a alguien con quien ya "
        "venías hablando -- no como si leyeras un guion. Evita frases hechas de IA "
